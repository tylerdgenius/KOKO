...
function OrganizationsetupToolbar(props) {
  const [
  ...
  const hasPermissionToCreate = useSelector(
    organizationsetupSelectors.selectPermissionToCreate,
  );
  const hasPermissionToImport = useSelector(
    organizationsetupSelectors.selectPermissionToImport,
  );
  ...
  return (
    <ToolbarWrapper>
      ...
      {hasPermissionToAuditLogs && (
        <Button
          component={Link}
          to="/audit-logs?entityNames=organizationsetup"
...
export default OrganizationsetupToolbar;
