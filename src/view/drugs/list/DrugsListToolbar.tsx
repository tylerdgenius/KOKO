...
function DrugsToolbar(props) {
  ...
  const hasPermissionToCreate = useSelector(
    drugsSelectors.selectPermissionToCreate,
  );
  const hasPermissionToImport = useSelector(
    drugsSelectors.selectPermissionToImport,
  );
  ...
  return (
    <ToolbarWrapper>
      ...
      {hasPermissionToAuditLogs && (
        <Button
          component={Link}
          to="/audit-logs?entityNames=drugs"
