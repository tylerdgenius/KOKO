...
const schema = yup.object().shape({
  ...
  //   i18n('entities.existinghospital.fields.birthdateRange'),
  // ),
  name: yupFilterSchemas.enumerator(
    i18n('entities.existinghospital.fields.name'),
  ),
});
...
const previewRenders = {
  ...
  // },
  // birthdateRange: {
  //   label: i18n('entities.existinghospital.fields.birthdateRange'),
  //   render: filterRenders.dateRange(),
  // },
  name: {
    label: i18n('entities.existinghospital.fields.name'),
    render: filterRenders.enumerator('entities.existinghospital.enumerators.name',),
  },
}

function ExistinghospitalListFilter(props) {
...
export default ExistinghospitalListFilter;