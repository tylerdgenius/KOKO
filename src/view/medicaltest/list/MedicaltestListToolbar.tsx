...
function MedicaltestToolbar(props) {
  const [
  ...
  const hasPermissionToCreate = useSelector(
    medicaltestSelectors.selectPermissionToCreate,
  );
  const hasPermissionToImport = useSelector(
    medicaltestSelectors.selectPermissionToImport,
  );
  ...
  return (
    <ToolbarWrapper>
      ...
      {hasPermissionToAuditLogs && (
        <Button
          component={Link}
          to="/audit-logs?entityNames=medicaltest"
...
export default MedicaltestToolbar;
