...
function OrganizationToolbar(props) {
  const [
  ...
  const hasPermissionToCreate = useSelector(
    organizationSelectors.selectPermissionToCreate,
  );
  const hasPermissionToImport = useSelector(
    organizationSelectors.selectPermissionToImport,
  );
  ...
  return (
    <ToolbarWrapper>
      ...
      {hasPermissionToAuditLogs && (
        <Button
          component={Link}
          to="/audit-logs?entityNames=organization"
