...
const schema = yup.object().shape({
  name: yupFilterSchemas.string(i18n("entities.organization.fields.name")),
  // birthdateRange: yupFilterSchemas.dateRange(
  //   i18n('entities.organization.fields.birthdateRange'),
  // ),
  // gender: yupFilterSchemas.enumerator(
  //   i18n('entities.organization.fields.gender'),
  // ),
});
...
const previewRenders = {
  ...
  // birthdateRange: {
  //   label: i18n('entities.organization.fields.birthdateRange'),
  //   render: filterRenders.dateRange(),
  // },
  // gender: {
  //   label: i18n('entities.organization.fields.gender'),
  //   render: filterRenders.enumerator('entities.organization.enumerators.gender',),
  // },
}
              ...
              <Grid container spacing={2}>
                ...
                <Grid item lg={6} xs={12}>
                  <SelectFormItem
                    name="gender"
                    label={i18n('entities.organization.fields.gender')}
                    options={organizationEnumerators.gender.map(
                      (value) => ({
                        value,
                        label: i18n(
                          `entities.organization.enumerators.gender.${value}`,
                        ),
                      }),
                    )}
                  />
