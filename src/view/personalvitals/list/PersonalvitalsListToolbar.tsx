...
function PersonalvitalsToolbar(props) {
  const [
  ...
  const hasPermissionToCreate = useSelector(
    personalvitalsSelectors.selectPermissionToCreate,
  );
  const hasPermissionToImport = useSelector(
    personalvitalsSelectors.selectPermissionToImport,
  );
  ...
  return (
    <ToolbarWrapper>
      ...
      {hasPermissionToAuditLogs && (
        <Button
          component={Link}
          to="/audit-logs?entityNames=personalvitals"
...
export default PersonalvitalsToolbar;
