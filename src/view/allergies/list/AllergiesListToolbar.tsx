...
function AllergiesToolbar(props) {
  const [
  ...
  const hasPermissionToCreate = useSelector(
    allergiesSelectors.selectPermissionToCreate,
  );
  const hasPermissionToImport = useSelector(
    allergiesSelectors.selectPermissionToImport,
  );
  ...
  return (
    <ToolbarWrapper>
      ...
      {hasPermissionToAuditLogs && (
        <Button
          component={Link}
          to="/audit-logs?entityNames=allergies"
...
export default AllergiesToolbar;
